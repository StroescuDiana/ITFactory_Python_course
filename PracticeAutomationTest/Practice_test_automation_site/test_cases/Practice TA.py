...
class LoginTest(unittest.TestCase):
    ...
    def test_successful_login(self):
        ...
        assert text_present, f"{RED} Expected text not found in page{RESET}"
        print(f"{GREEN}Expected text found on the page{RESET}")
        ...
        print(f"{GREEN} 'Log out' button is successfuly displayed{RESET}.")
