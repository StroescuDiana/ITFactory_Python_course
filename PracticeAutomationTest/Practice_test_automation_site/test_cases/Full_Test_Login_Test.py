...
class LoginTest(unittest.TestCase, LoginPageObjects):
    ...
    def test_login_success(self):
        ...
        time.sleep(2)
        username_locator.send_keys(Keys.CONTROL, 'a')
        time.sleep(1)
        username_locator.send_keys(Keys.BACKSPACE)
        time.sleep(2)
        username_locator.send_keys("student@pop.con")
        username_locator.send_keys(Keys.SHIFT, Keys.ARROW_LEFT)
        username_locator.send_keys('m')
        time.sleep(2)
